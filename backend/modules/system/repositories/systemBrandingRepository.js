...
const upsertBranding = async (schoolId, data = {}, updatedBy) => {
  await executeQuery(
    `
      ...
      WHEN MATCHED THEN
        UPDATE SET
          ...
          TopbarLogoX = @TopbarLogoX,
          TopbarLogoY = @TopbarLogoY,
          TopbarLogoWidth = @TopbarLogoWidth,
          TopbarLogoHeight = @TopbarLogoHeight,
    ...
    [
      ...
      { name: "TopbarLogoX", type: sql.Int, value: data.floatingLogoX ?? 1200 },
      { name: "TopbarLogoY", type: sql.Int, value: data.floatingLogoY ?? 96 },
      { name: "TopbarLogoWidth", type: sql.Int, value: data.floatingLogoSize ?? 72 },
      { name: "TopbarLogoHeight", type: sql.Int, value: data.floatingLogoSize ?? 72 },
